  ...
  return (
    <section id="global-presence" className="bg-white py-[var(--section-y)]">
      <Container>
        ...
        >
          <h2 className="mx-auto max-w-3xl text-center font-display text-[clamp(1.35rem,2.4vw,2rem)] leading-[1.35] font-light tracking-tight text-oboya-blue-dark text-balance">
            {heading}
          </h2>
        </motion.div>
