  ...
  if (locale === "en") {
    ...
    data.faqsPage = {
      ...
      products: {
        ...
        q2: { question: "Are all products available in the shop?", answer: "The complete product range may vary by region. The shop shows only items currently available in your market." },
